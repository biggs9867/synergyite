...
function tameer_construction_guide() {
	...
	<div class="wrap getting-started">
		<div class="getting-started__header">
			...
			<div class="tab">
			  <button role="tab" class="tablinks" onclick="tameer_construction_open(event, 'lite_theme')">Getting Started</button>		  
			  <button role="tab" class="tablinks" onclick="tameer_construction_open(event, 'pro_theme')">Get Premium</button>
			</div>
						...
						<div class="pad-box">
		                    <div class="table-image">
								<table class="tablebox">
									<thead>
										<tr>
											<th><?php esc_html_e('Setup', 'tameer-construction'); ?></th>
											<th><?php esc_html_e('Click Here', 'tameer-construction'); ?></th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td><?php esc_html_e('Logo', 'tameer-construction'); ?></td>
											<td class="table-img"><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Click', 'tameer-construction'); ?></a></td>
										</tr>
									</tbody>
									<tbody>
										<tr>
											<td><?php esc_html_e('Menus', 'tameer-construction'); ?></td>
											<td class="table-img"><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Click', 'tameer-construction'); ?></a></td>
										</tr>
									</tbody>
									<tbody>
										<tr>
											<td><?php esc_html_e('Top Header', 'tameer-construction'); ?></td>
											<td class="table-img"><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=tameer_construction_topbar') ); ?>" target="_blank"><?php esc_html_e('Click', 'tameer-construction'); ?></a></td>
										</tr>
									</tbody>
									<tbody>
										<tr>
											<td><?php esc_html_e('Slider', 'tameer-construction'); ?></td>
											<td class="table-img"><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=tameer_construction_slider') ); ?>" target="_blank"><?php esc_html_e('Click', 'tameer-construction'); ?></a></td>
										</tr>
									</tbody>
									<tbody>
										<tr>
											<td><?php esc_html_e('Post Settings', 'tameer-construction'); ?></td>
											<td class="table-img"><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=tameer_construction_blog_post') ); ?>" target="_blank"><?php esc_html_e('Click', 'tameer-construction'); ?></a></td>
										</tr>
									</tbody>
									<tbody>
										<tr>
											<td><?php esc_html_e('Footer', 'tameer-construction'); ?></td>
											<td class="table-img"><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=tameer_construction_footer') ); ?>" target="_blank"><?php esc_html_e('Click', 'tameer-construction'); ?></a></td>
										</tr>
									</tbody>
								</table>
							</div>
          	...
          	<div class="dashboard__blocks">
				<div class="row">
					...
					<div class="col-md-3">
						...
						<ol>
							<li><a href="<?php echo esc_url( TAMEER_CONSTRUCTION_BUY_PRO ); ?>"><?php esc_html_e('Buy Pro', 'tameer-construction'); ?></a></li>
						</ol>
					</div>
				</div>
			</div>
