...
function tameer_construction_custom_controls() {

	load_template( trailingslashit( get_template_directory() ) . '/inc/custom-control.php' );
}

add_action( 'customize_register', 'tameer_construction_custom_controls' );
...
function tameer_construction_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'tameer_construction_body_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'tameer_construction_body_color', array(
		'label' => __('Body Color', 'tameer-construction'),
		'section' => 'tameer_construction_typography',
		'settings' => 'tameer_construction_body_color',
	)));

	//This is Body FontFamily  setting
	$wp_customize->add_setting('tameer_construction_body_font_family',array(
	  'default' => '',
	  'capability' => 'edit_theme_options',
	  'sanitize_callback' => 'tameer_construction_sanitize_choices'
	));
	$wp_customize->add_control(
		'tameer_construction_body_font_family', array(
		'section'  => 'tameer_construction_typography',
		'label'    => __( 'Body Fonts','tameer-construction'),
		'type'     => 'select',
		'choices'  => $tameer_construction_font_array,
	));

    //This is Body Fontsize setting
	$wp_customize->add_setting('tameer_construction_body_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('tameer_construction_body_font_size',array(
		'label'	=> __('Body Font Size','tameer-construction'),
		'section'	=> 'tameer_construction_typography',
		'setting'	=> 'tameer_construction_body_font_size',
		'type'	=> 'text'
	));
    ...
    $wp_customize->add_setting('tameer_construction_shop_page_sidebar',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_shop_page_sidebar',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Shop Page Sidebar','tameer-construction'),
       'section' => 'tameer_construction_shop_page_options',
    ));

    $wp_customize->add_setting('tameer_construction_single_product_sidebar',array(
        'default' => true,
        'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
	));
	$wp_customize->add_control('tameer_construction_single_product_sidebar',array(
     	'type' => 'checkbox',
      	'label' => __('Enable / Disable Single Product Sidebar','tameer-construction'),
      	'section' => 'tameer_construction_shop_page_options',
	));
	...
	$wp_customize->add_setting('tameer_construction_position_product_sale',array(
        'default' => 'Right',
        'sanitize_callback' => 'tameer_construction_sanitize_choices'
	));
	$wp_customize->add_control('tameer_construction_position_product_sale',array(
        'type' => 'radio',
        'label' => __('Product Sale Position','tameer-construction'),
        'section' => 'tameer_construction_shop_page_options',
        'choices' => array(
	...
	$wp_customize->add_setting( 'tameer_construction_border_radius_product_sale_text',array(
		'default' => 50,
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_border_radius_product_sale_text', array(
        'label'  => __('Product Sale Border Radius','tameer-construction'),
        'section'  => 'tameer_construction_shop_page_options',
        'type'        => 'number',
        'input_attrs' => array(
        	'step'=> 1,
    ...
    $wp_customize->add_setting('tameer_construction_top_bottom_product_sale_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_top_bottom_product_sale_padding',array(
		'label'	=> __('Top / Bottom Product Sale Padding ','tameer-construction'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('tameer_construction_left_right_product_sale_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_left_right_product_sale_padding',array(
		'label'	=> __('Left / Right Product Sale Padding','tameer-construction'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('tameer_construction_product_sale_text_size',array(
		'default'=> 14,
		'sanitize_callback'	=> 'tameer_construction_sanitize_float'
	));
	$wp_customize->add_control('tameer_construction_product_sale_text_size',array(
		'label'	=> __('Product Sale Text Size','tameer-construction'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('tameer_construction_shop_products_navigation',array(
       'default' => 'Yes',
       'sanitize_callback'	=> 'tameer_construction_sanitize_choices'
    ));
    $wp_customize->add_control('tameer_construction_shop_products_navigation',array(
       'type' => 'radio',
       'label' => __('Woocommerce Products Navigation','tameer-construction'),
       'choices' => array(
            'Yes' => __('Yes','tameer-construction'),
            'No' => __('No','tameer-construction'),
        ),
       'section' => 'tameer_construction_shop_page_options',
    ));
	...
	$wp_customize->add_setting( 'tameer_construction_single_page_breadcrumb',array(
		'default' => true,
		'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
	) );
	$wp_customize->add_control('tameer_construction_single_page_breadcrumb',array(
		'type' => 'checkbox',
		'label' => __( 'Show / Hide Single Page Breadcrumb','tameer-construction'),
		'section' => 'tameer_construction_width_layout'
	));

	// show/hide search
	$wp_customize->add_setting( 'tameer_construction_show_hide_search',array(
		'default' => true,
      	'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ) );
    $wp_customize->add_control('tameer_construction_show_hide_search',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Search','tameer-construction' ),
        'section' => 'tameer_construction_width_layout'
    ));

    $wp_customize->add_setting('tameer_construction_search_icon_changer',array(
		'default'	=> 'fas fa-search',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_search_icon_changer',array(
		'label'	=> __('Search Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_width_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting( 'tameer_construction_fixed_header_padding_option', array(
		'default'=> '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	) );
	$wp_customize->add_control( 'tameer_construction_fixed_header_padding_option', array(
		'label'       => esc_html__( 'Fixed Header Padding','tameer-construction' ),
		'section'     => 'tameer_construction_width_layout',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'tameer_construction_post_image_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	) );
	$wp_customize->add_control( 'tameer_construction_post_image_border_radius', array(
		'label'       => esc_html__( 'Featured Image Border Radius','tameer-construction' ),
		'section'     => 'tameer_construction_width_layout',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'tameer_construction_featured_image_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'tameer_construction_sanitize_number_range',
	));
	$wp_customize->add_control('tameer_construction_featured_image_box_shadow',array(
		'label' => esc_html__( 'Featured Image Shadow','tameer-construction' ),
		'section' => 'tameer_construction_width_layout',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting('tameer_construction_email_icon_changer',array(
		'default'	=> 'fas fa-envelope',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_email_icon_changer',array(
		'label'	=> __('Email Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_topbar',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('tameer_construction_phone_icon_changer',array(
		'default'	=> 'fas fa-phone-volume',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_phone_icon_changer',array(
		'label'	=> __('Phone Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_topbar',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('tameer_construction_time_icon_changer',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_time_icon_changer',array(
		'label'	=> __('Time Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_topbar',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('tameer_construction_facebook_icon_changer',array(
		'default'	=> 'fab fa-facebook-f',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_facebook_icon_changer',array(
		'label'	=> __('Facebook Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_social_link',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('tameer_construction_twitter_icon_changer',array(
		'default'	=> 'fab fa-twitter',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_twitter_icon_changer',array(
		'label'	=> __('Twitter Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_social_link',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('tameer_construction_youtube_icon_changer',array(
		'default'	=> 'fab fa-youtube',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_youtube_icon_changer',array(
		'label'	=> __('Youtube Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_social_link',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('tameer_construction_linkdin_icon_changer',array(
		'default'	=> 'fab fa-linkedin-in',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_linkdin_icon_changer',array(
		'label'	=> __('Linkdin Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_social_link',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('tameer_construction_instagram_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	) );	
	$wp_customize->add_control('tameer_construction_instagram_url',array(
		'label'	=> __('Add Instagram link','tameer-construction'),
		'section'	=> 'tameer_construction_social_link',
		'setting'	=> 'tameer_construction_instagram_url',
		'type'	=> 'url'
	) );

	$wp_customize->add_setting('tameer_construction_instagram_icon_changer',array(
		'default'	=> 'fab fa-instagram',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_instagram_icon_changer',array(
		'label'	=> __('Instagram Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_social_link',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('tameer_construction_slider_width_options',array(
    	'default' => 'Full Width',
     	'sanitize_callback' => 'tameer_construction_sanitize_choices'
	));
	$wp_customize->add_control('tameer_construction_slider_width_options',array(
		'type' => 'select',
		'label' => __('Slider Width Layout','tameer-construction'),
		'description' => __('Here you can change the Slider Width. ','tameer-construction'),
		'section' => 'tameer_construction_slider',
		'choices' => array(
		   'Full Width' => __('Full Width','tameer-construction'),
		   'Container Width' => __('Container Width','tameer-construction'),
		),
	) );
	...
	$wp_customize->add_setting('tameer_construction_padding_top_bottom_slider_content',array(
		'default'=> '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_padding_top_bottom_slider_content',array(
		'label'	=> __('Top Bottom Slider Content Padding','tameer-construction'),
		'section'=> 'tameer_construction_slider',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('tameer_construction_padding_left_right_slider_content',array(
		'default'=> '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_padding_left_right_slider_content',array(
		'label'	=> __('Left Right Slider Content Padding','tameer-construction'),
		'section'=> 'tameer_construction_slider',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('tameer_construction_show_slider_image_overlay',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_show_slider_image_overlay',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Image Overlay Slider','tameer-construction'),
       'section' => 'tameer_construction_slider'
    ));

    $wp_customize->add_setting('tameer_construction_color_slider_image_overlay', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'tameer_construction_color_slider_image_overlay', array(
		'label'    => __('Image Overlay Slider Color', 'tameer-construction'),
		'section'  => 'tameer_construction_slider',
		'settings' => 'tameer_construction_color_slider_image_overlay',
	)));
	...
	$wp_customize->add_setting('tameer_construction_enable_disable_preloader',array(
       'default' => false,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_enable_disable_preloader',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Preloader','tameer-construction'),
    ...
    $wp_customize->add_setting('tameer_construction_post_date_icon_changer',array(
		'default'	=> 'fa fa-calendar',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_post_date_icon_changer',array(
		'label'	=> __('Post Date Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_blog_post',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('tameer_construction_post_author_icon_changer',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_post_author_icon_changer',array(
		'label'	=> __('Post Author Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_blog_post',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('tameer_construction_post_comment_icon_changer',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_post_comment_icon_changer',array(
		'label'	=> __('Post Comments Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_blog_post',
		'type'		=> 'icon'
	)));

    	$wp_customize->add_setting('tameer_construction_blog_post_featured_image',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_blog_post_featured_image',array(
       'type' => 'checkbox',
       'label' => __('Post Image','tameer-construction'),
       'section' => 'tameer_construction_blog_post'
    ));

    $wp_customize->add_setting( 'tameer_construction_blog_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	) );
	$wp_customize->add_control( 'tameer_construction_blog_post_img_border_radius', array(
		'label'       => esc_html__( 'Post Image Border Radius','tameer-construction' ),
		'section'     => 'tameer_construction_blog_post',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'tameer_construction_blog_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_blog_post_img_box_shadow',array(
		'label' => esc_html__( 'Post Image Shadow','tameer-construction' ),
		'section' => 'tameer_construction_blog_post',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting('tameer_construction_post_break_block_setting',array(
        'default' => 'Into Blocks',
        'sanitize_callback' => 'tameer_construction_sanitize_choices'
	));
	$wp_customize->add_control('tameer_construction_post_break_block_setting',array(
        'type' => 'radio',
        'label' => __('Display Blog Page posts','tameer-construction'),
        'section' => 'tameer_construction_blog_post',
        'choices' => array(
            'Into Blocks' => __('Into Blocks','tameer-construction'),
            'Without Blocks' => __('Without Blocks','tameer-construction'),
        ),
	) );

	$wp_customize->add_setting('tameer_construction_post_image_dimention',array(
       'default' => 'Default',
       'sanitize_callback'	=> 'tameer_construction_sanitize_choices'
    ));
    $wp_customize->add_control('tameer_construction_post_image_dimention',array(
       'type' => 'radio',
       'label'	=> __('Post Featured Image Dimention','tameer-construction'),
       'choices' => array(
            'Default' => __('Default','tameer-construction'),
            'Custom Image Size' => __('Custom Image Size','tameer-construction'),
        ),
      	'section'	=> 'tameer_construction_blog_post'
    ));

    $wp_customize->add_setting( 'tameer_construction_post_featured_image_width',array(
		'default' => '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_number_range'
	));
	$wp_customize->add_control('tameer_construction_post_featured_image_width',	array(
		'label' => esc_html__( 'Blog Post Custom Width','tameer-construction' ),
		'section' => 'tameer_construction_blog_post',
		'input_attrs' => array(
			'min' => 0,
			'max' => 500,
		...
		'type' => 'range',
		'active_callback' => 'tameer_construction_enable_image_dimention'
	));

	$wp_customize->add_setting( 'tameer_construction_post_featured_image_height',array(
		'default' => '',
		'sanitize_callback'	=> 'tameer_construction_sanitize_number_range'
	));
	$wp_customize->add_control('tameer_construction_post_featured_image_height',	array(
		'label' => esc_html__( 'Blog Post Custom Height','tameer-construction' ),
		'section' => 'tameer_construction_blog_post',
		'input_attrs' => array(
			'min' => 0,
			'max' => 350,
	...
	$wp_customize->add_setting('tameer_construction_single_post_breadcrumb',array(
		'default' => false,
		'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
	));
	$wp_customize->add_control('tameer_construction_single_post_breadcrumb',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Breadcrumb','tameer-construction'),
    ...
    $wp_customize->add_control('tameer_construction_single_post_image',array(
     ...
     $wp_customize->add_setting( 'tameer_construction_single_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'tameer_construction_sanitize_float',
	) );
	$wp_customize->add_control( 'tameer_construction_single_post_img_border_radius', array(
		'label'       => esc_html__( 'Single Post Image Border Radius','tameer-construction' ),
		'section'     => 'tameer_construction_single_post_section',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'tameer_construction_single_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'tameer_construction_sanitize_float',
	));
	$wp_customize->add_control('tameer_construction_single_post_img_box_shadow',array(
		'label' => esc_html__( 'Single Post Image Shadow','tameer-construction' ),
		'section' => 'tameer_construction_single_post_section',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
    ...
    $wp_customize->add_setting('tameer_construction_single_post_date',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_single_post_date',array(
       'type' => 'checkbox',
       'label' => __('Single Post Date','tameer-construction'),
       'section' => 'tameer_construction_single_post_section'
    ));

    $wp_customize->add_setting('tameer_construction_single_post_comment',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_single_post_comment',array(
       'type' => 'checkbox',
       'label' => __('Single Post Comments','tameer-construction'),
       'section' => 'tameer_construction_single_post_section'
    ));

    $wp_customize->add_setting('tameer_construction_single_post_author',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_single_post_author',array(
       'type' => 'checkbox',
       'label' => __('Single Post Author','tameer-construction'),
       'section' => 'tameer_construction_single_post_section'
    ));

     $wp_customize->add_setting('tameer_construction_show_single_post_pagination',array(
       'default' => true,
       'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
    ));
    $wp_customize->add_control('tameer_construction_show_single_post_pagination',array(
       'type' => 'checkbox',
       'label' => __('Single Post Pagination','tameer-construction'),
       'section' => 'tameer_construction_single_post_section'
    ));

     $wp_customize->add_setting('tameer_construction_prev_text',array(
       'default' => '',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('tameer_construction_prev_text',array(
       'type' => 'text',
       'label' => __('Previous Navigation Text','tameer-construction'),
       'section' => 'tameer_construction_single_post_section'
    ));

    $wp_customize->add_setting('tameer_construction_next_text',array(
       'default' => '',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('tameer_construction_next_text',array(
       'type' => 'text',
       'label' => __('Next Navigation Text','tameer-construction'),
       'section' => 'tameer_construction_single_post_section'
    ));

    $wp_customize->add_setting('tameer_construction_show_hide_single_post_categories',array(
		'default' => true,
		'sanitize_callback'	=> 'tameer_construction_sanitize_checkbox'
 	));
 	$wp_customize->add_control('tameer_construction_show_hide_single_post_categories',array(
		'type' => 'checkbox',
		'label' => __('Single Post Categories','tameer-construction'),
		'section' => 'tameer_construction_single_post_section'
	));
	...
	$wp_customize->add_setting('tameer_construction_scroll_icon_changer',array(
		'default'	=> 'fas fa-long-arrow-alt-up',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new tameer_construction_Icon_Changer(
        $wp_customize,'tameer_construction_scroll_icon_changer',array(
		'label'	=> __('Scroll To Top Icon','tameer-construction'),
		'transport' => 'refresh',
		'section'	=> 'tameer_construction_footer',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_control('tameer_construction_copyright_top_bottom_padding',array(
	 ...
	 $wp_customize->add_setting('tameer_construction_copyright_background_color', array(
		'default'           => '#c90900',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'tameer_construction_copyright_background_color', array(
		'label'    => __('Copyright Background Color', 'tameer-construction'),
		'section'  => 'tameer_construction_footer',
	)));
