...
<body <?php body_class(); ?>>
	...
	<?php if(get_theme_mod('tameer_construction_loader_setting',false) != '' || get_theme_mod('tameer_construction_enable_disable_preloader',false) != ''){ ?>
	    <div id="pre-loader">
	      <div class='demo'>
	...
	<div id="page" class="site">
		<header id="masthead" class="site-header" role="banner">
			<div class="main-header">
				<div class="container">
					<div class="row">
						<div class="logo col-lg-3 col-md-3 p-4 text-md-start text-center">
							<?php if ( has_custom_logo() ) : ?>
				              <div class="site-logo align-self-center align-self-center"><?php the_custom_logo(); ?></div>
				            <?php endif; ?>
