<?php
	...
	$tameer_construction_custom_css .='a, .mail i, .call i, .time i, .social-media i:hover, .post-info i, .main-navigation ul ul li a,.main-navigation li li:focus > a,.main-navigation li li:hover > a,#sidebox ul li a:hover,.entry-date a:hover, .entry-author a:hover, .mail a:hover, .call a:hover, .blogger h2 a:hover, .related-posts h3 a:hover, .category a:hover{';
    ...
    if($tameer_construction_theme_lay == 'Default'){
		...
		$tameer_construction_custom_css .='body{';
			$tameer_construction_custom_css .='padding-right: 15px; padding-left: 15px;margin-right: auto;margin-left: auto;';
		$tameer_construction_custom_css .='}';
		$tameer_construction_custom_css .='.page-template-custom-home-page .middle-header{';
		...
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
			$tameer_construction_custom_css .='width: 85%';
		$tameer_construction_custom_css .='}';
		$tameer_construction_custom_css .='@media screen and (max-width:768px) {';
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
			$tameer_construction_custom_css .='width: 100%;';
		$tameer_construction_custom_css .='} }';
		$tameer_construction_custom_css .='@media screen and (min-width:992px) and (max-width:1024px){';
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
			$tameer_construction_custom_css .='width: 95%;';
		$tameer_construction_custom_css .='} }';
	}
	...
	// Responsive Media
    $tameer_construction_preloader = get_theme_mod( 'tameer_construction_enable_disable_preloader', false);
	if($tameer_construction_preloader == true && get_theme_mod( 'tameer_construction_loader_setting', false) == false){
    	$tameer_construction_custom_css .='#pre-loader{';
			$tameer_construction_custom_css .='visibility:hidden;';
		$tameer_construction_custom_css .='} ';
	}
    if($tameer_construction_preloader == true){
    	$tameer_construction_custom_css .='@media screen and (max-width:575px) {';
		$tameer_construction_custom_css .='#pre-loader{';
			$tameer_construction_custom_css .='visibility:visible;';
		$tameer_construction_custom_css .='} }';
	}else if($tameer_construction_preloader == false){
		$tameer_construction_custom_css .='@media screen and (max-width:575px) {';
		$tameer_construction_custom_css .='#pre-loader{';
			$tameer_construction_custom_css .='visibility:hidden;';
		$tameer_construction_custom_css .='} }';
	...
	$tameer_construction_stickyheader = get_theme_mod( 'tameer_construction_enable_disable_topbar',false);
	if($tameer_construction_stickyheader == true && get_theme_mod( 'tameer_construction_show_hide_topbar', false) == false){
	...
	$tameer_construction_slider = get_theme_mod( 'tameer_construction_enable_disable_slider', false);
	if($tameer_construction_slider == true && get_theme_mod( 'tameer_construction_slider_arrows', false) == false){
    	$tameer_construction_custom_css .='#slider{';
			$tameer_construction_custom_css .='display:none;';
		$tameer_construction_custom_css .='} ';
	}
    if($tameer_construction_slider == true){
    	$tameer_construction_custom_css .='@media screen and (max-width:575px) {';
		$tameer_construction_custom_css .='#slider{';
			$tameer_construction_custom_css .='display:block;';
		$tameer_construction_custom_css .='} }';
	}else if($tameer_construction_slider == false){
		$tameer_construction_custom_css .='@media screen and (max-width:575px){';
		$tameer_construction_custom_css .='#slider{';
			$tameer_construction_custom_css .='display:none;';
		$tameer_construction_custom_css .='} }';
	...
	$tameer_construction_scroll = get_theme_mod( 'tameer_construction_enable_disable_scrolltop',false);
	if($tameer_construction_scroll == true && get_theme_mod( 'tameer_construction_hide_show_scroll', false) == false){
    	$tameer_construction_custom_css .='.scrollup i{';
			$tameer_construction_custom_css .='display:none;';
		$tameer_construction_custom_css .='} ';
	}
    if($tameer_construction_scroll == true){
    	$tameer_construction_custom_css .='@media screen and (max-width:575px) {';
		$tameer_construction_custom_css .='.scrollup i{';
			$tameer_construction_custom_css .='display:block;';
		$tameer_construction_custom_css .='} }';
	}else if($tameer_construction_scroll == false){
		$tameer_construction_custom_css .='@media screen and (max-width:575px){';
		$tameer_construction_custom_css .='.scrollup i{';
			$tameer_construction_custom_css .='display:none;';
		$tameer_construction_custom_css .='} }';
	...
	// css
	$tameer_construction_slider_arrows = get_theme_mod( 'tameer_construction_slider_arrows', false);
	if($tameer_construction_slider_arrows == false){
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
	...
	$tameer_construction_show_header = get_theme_mod( 'tameer_construction_show_hide_topbar', false);
	...
	$tameer_construction_site_title_color_setting = get_theme_mod('tameer_construction_site_title_color_setting');
	$tameer_construction_custom_css .=' .logo h1 a,.site-title a{';
		$tameer_construction_custom_css .='color: '.esc_attr($tameer_construction_site_title_color_setting).';';
	$tameer_construction_custom_css .='} ';

	$tameer_construction_tagline_color_setting = get_theme_mod('tameer_construction_tagline_color_setting');
	$tameer_construction_custom_css .=' .site-description{';
		$tameer_construction_custom_css .='color: '.esc_attr($tameer_construction_tagline_color_setting).';';
	$tameer_construction_custom_css .='} ';
	...
	$tameer_construction_site_tagline_font_size_settings = get_theme_mod('tameer_construction_site_tagline_font_size_settings', 16);{
	$tameer_construction_custom_css .='.logo p{';
	$tameer_construction_custom_css .='font-size: '.esc_attr($tameer_construction_site_tagline_font_size_settings).'px !important;';
		$tameer_construction_custom_css .='}';
	}
	...
	// slider overlay
	$tameer_construction_show_slider_image_overlay = get_theme_mod('tameer_construction_show_slider_image_overlay', true);
	if($tameer_construction_show_slider_image_overlay == false){
		$tameer_construction_custom_css .='#slider img{';
			$tameer_construction_custom_css .='opacity:0.7;';
		$tameer_construction_custom_css .='}';
	} 
	$tameer_construction_color_slider_image_overlay = get_theme_mod('tameer_construction_color_slider_image_overlay', true);
	if($tameer_construction_show_slider_image_overlay != false){
		$tameer_construction_custom_css .='#slider{';
			$tameer_construction_custom_css .='background-color: '.esc_attr($tameer_construction_color_slider_image_overlay).';';
		$tameer_construction_custom_css .='}';
	}

	// woocommerce product sale settings
	$tameer_construction_border_radius_product_sale_text = get_theme_mod('tameer_construction_border_radius_product_sale_text',50);
	$tameer_construction_custom_css .='.woocommerce span.onsale {';
		$tameer_construction_custom_css .='border-radius: '.esc_attr($tameer_construction_border_radius_product_sale_text).'%;';
	$tameer_construction_custom_css .='}';

	$tameer_construction_position_product_sale = get_theme_mod('tameer_construction_position_product_sale', 'Right');
	if($tameer_construction_position_product_sale == 'Right' ){
		$tameer_construction_custom_css .='.woocommerce ul.products li.product .onsale{';
			$tameer_construction_custom_css .=' left:auto; right:0;';
		$tameer_construction_custom_css .='}';
	}elseif($tameer_construction_position_product_sale == 'Left' ){
		$tameer_construction_custom_css .='.woocommerce ul.products li.product .onsale{';
			$tameer_construction_custom_css .=' left:0; right:auto;';
		$tameer_construction_custom_css .='}';
	}

	$tameer_construction_product_sale_text_size = get_theme_mod('tameer_construction_product_sale_text_size',14);
	$tameer_construction_custom_css .='.woocommerce span.onsale{';
		$tameer_construction_custom_css .='font-size: '.esc_attr($tameer_construction_product_sale_text_size).'px;';
	$tameer_construction_custom_css .='}';

	$tameer_construction_top_bottom_product_sale_padding = get_theme_mod('tameer_construction_top_bottom_product_sale_padding');
	$tameer_construction_left_right_product_sale_padding = get_theme_mod('tameer_construction_left_right_product_sale_padding');
	$tameer_construction_custom_css .='.woocommerce span.onsale{';
		$tameer_construction_custom_css .='padding-top: '.esc_attr($tameer_construction_top_bottom_product_sale_padding).'px; padding-bottom: '.esc_attr($tameer_construction_top_bottom_product_sale_padding).'px; padding-left: '.esc_attr($tameer_construction_left_right_product_sale_padding).'px; padding-right: '.esc_attr($tameer_construction_left_right_product_sale_padding).'px; display:inline-block;';
	$tameer_construction_custom_css .='}';

	// woocommerce Product Navigation
	$tameer_construction_shop_products_navigation = get_theme_mod('tameer_construction_shop_products_navigation', 'Yes');
	if($tameer_construction_shop_products_navigation == 'No'){
		$tameer_construction_custom_css .='.woocommerce nav.woocommerce-pagination{';
			$tameer_construction_custom_css .='display: none;';
		$tameer_construction_custom_css .='}';
	}

	// Post Block
	$tameer_construction_post_break_block_setting = get_theme_mod( 'tameer_construction_post_break_block_setting','Into Blocks');
    if($tameer_construction_post_break_block_setting == 'Without Blocks'){
		$tameer_construction_custom_css .='.blogger{';
			$tameer_construction_custom_css .='border: none; margin:30px 0;';
		$tameer_construction_custom_css .='}';
	}

	// fixed header padding option
	$tameer_construction_fixed_header_padding_option = get_theme_mod('tameer_construction_fixed_header_padding_option');
	$tameer_construction_custom_css .='.fixed-header{';
		$tameer_construction_custom_css .='padding: '.esc_attr($tameer_construction_fixed_header_padding_option).'px;';
	$tameer_construction_custom_css .='}';

	// slider top and bottom padding
	$tameer_construction_padding_top_bottom_slider_content = get_theme_mod('tameer_construction_padding_top_bottom_slider_content');
	$tameer_construction_padding_left_right_slider_content = get_theme_mod('tameer_construction_padding_left_right_slider_content');
	$tameer_construction_custom_css .='#slider .carousel-caption, #slider .inner_carousel, #slider .inner_carousel h1, #slider .inner_carousel p, #slider .readbutton{';
		$tameer_construction_custom_css .='top: '.esc_attr($tameer_construction_padding_top_bottom_slider_content).'%; bottom: '.esc_attr($tameer_construction_padding_top_bottom_slider_content).'%;left: '.esc_attr($tameer_construction_padding_left_right_slider_content).'%;right: '.esc_attr($tameer_construction_padding_left_right_slider_content).'%;';
	$tameer_construction_custom_css .='}';

	// featured image setting
	$tameer_construction_post_image_border_radius = get_theme_mod('tameer_construction_post_image_border_radius', 0);
	$tameer_construction_custom_css .='.post-image img, .wrapper img{';
		$tameer_construction_custom_css .='border-radius: '.esc_attr($tameer_construction_post_image_border_radius).'px;';
	$tameer_construction_custom_css .='}';

	$tameer_construction_featured_image_box_shadow = get_theme_mod('tameer_construction_featured_image_box_shadow',0);
	$tameer_construction_custom_css .='.post-image img, .wrapper img{';
		$tameer_construction_custom_css .='box-shadow: '.esc_attr($tameer_construction_featured_image_box_shadow).'px '.esc_attr($tameer_construction_featured_image_box_shadow).'px '.esc_attr($tameer_construction_featured_image_box_shadow).'px #ccc;';
	$tameer_construction_custom_css .='}';
	
     //Copyright background css
	$tameer_construction_copyright_background_color = get_theme_mod('tameer_construction_copyright_background_color');
	$tameer_construction_custom_css .='.copyright{';
		$tameer_construction_custom_css .='background-color: '.esc_attr($tameer_construction_copyright_background_color).';';
	$tameer_construction_custom_css .='}';

	// featured image dimention
	$tameer_construction_post_image_dimention = get_theme_mod('tameer_construction_post_image_dimention', 'Default');
	$tameer_construction_post_featured_image_width = get_theme_mod('tameer_construction_post_featured_image_width');
	$tameer_construction_post_featured_image_height = get_theme_mod('tameer_construction_post_featured_image_height');
	if($tameer_construction_post_image_dimention == 'Custom Image Size'){
		$tameer_construction_custom_css .='.post-image img{';
			$tameer_construction_custom_css .='width: '.esc_attr($tameer_construction_post_featured_image_width).'px; height: '.esc_attr($tameer_construction_post_featured_image_height).'px;';
		$tameer_construction_custom_css .='}';
	}
     
    // Single Post Categories
	$tameer_construction_show_hide_single_post_categories = get_theme_mod('tameer_construction_show_hide_single_post_categories',false);
	if ($tameer_construction_show_hide_single_post_categories == false) {
		$tameer_construction_custom_css .='.post-info{';
			$tameer_construction_custom_css .=' margin-top:20px;';
		$tameer_construction_custom_css .='}';
	}

    // Slider Width Layout
	$tameer_construction_slider_width_options = get_theme_mod('tameer_construction_slider_width_options', 'Full Width');
	if($tameer_construction_slider_width_options == 'Full Width' ){
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
			$tameer_construction_custom_css .=' position:absolute;';
		$tameer_construction_custom_css .='}';
	}elseif($tameer_construction_slider_width_options == 'Container Width' ){
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
			$tameer_construction_custom_css .=' position:static;';
		$tameer_construction_custom_css .='}';
		$tameer_construction_custom_css .='.page-template-home-custom #masthead .main-header{';
			$tameer_construction_custom_css .=' margin-top:0px;';
		$tameer_construction_custom_css .='}';
	}

	 // Blog post image border radious
    $tameer_construction_blog_post_img_border_radius = get_theme_mod('tameer_construction_blog_post_img_border_radius', 0);
	$tameer_construction_custom_css .='.post-image img{';
		$tameer_construction_custom_css .='border-radius: '.esc_attr($tameer_construction_blog_post_img_border_radius).'px;';
	$tameer_construction_custom_css .='}';

     // Blog post image box shadow
	$tameer_construction_blog_post_img_box_shadow = get_theme_mod('tameer_construction_blog_post_img_box_shadow',0);
	$tameer_construction_custom_css .='.post-image img{';
		$tameer_construction_custom_css .='box-shadow: '.esc_attr($tameer_construction_blog_post_img_box_shadow).'px '.esc_attr($tameer_construction_blog_post_img_box_shadow).'px '.esc_attr($tameer_construction_blog_post_img_box_shadow).'px #ccc;';
	$tameer_construction_custom_css .='}';

    // Single post image border radious
	$tameer_construction_single_post_img_border_radius = get_theme_mod('tameer_construction_single_post_img_border_radius', 0);
	$tameer_construction_custom_css .='.blogger.singlebox .single-post-image img{';
		$tameer_construction_custom_css .='border-radius: '.esc_attr($tameer_construction_single_post_img_border_radius).'px;';
	$tameer_construction_custom_css .='}';

	 // Single post image box shadow
	$tameer_construction_single_post_img_box_shadow = get_theme_mod('tameer_construction_single_post_img_box_shadow',0);
	$tameer_construction_custom_css .='.blogger.singlebox .single-post-image img{';
		$tameer_construction_custom_css .='box-shadow: '.esc_attr($tameer_construction_single_post_img_box_shadow).'px '.esc_attr($tameer_construction_single_post_img_box_shadow).'px '.esc_attr($tameer_construction_single_post_img_box_shadow).'px #ccc;';
	$tameer_construction_custom_css .='}';
