...
= 0.3.9 =
  * Added Hamburger Navigation in mobile media.
...
= 0.4.9 =
  ...
  * Post category show / hide option.
...
= 0.7.4 =
  ...
  * Removed underline from single post comment section.
  * Done metabox date and author hover css.
...
= 0.7.9 =
  * added top and bottom slider content spacing option.
  * added left and right slider content spacing option.
  * Updated mo and po files of different languages.

= 0.8 =
  * added enable / disable option for slider heading.
  * Updated POT file.

= 0.8.1 =
  * added enable / disable option for slider text.
  * Updated POT file.
...
= 0.8.5 =
  * Added menu padding option.
  * Updated POT file.

= 0.8.6 =
  * Added condition for slider image in custom-home-page.php file.
...
= 0.8.8 =
  * Resolved slider button error from responsive.
...
= 0.9.2 =
  ...
  * Added blog post shown by block and without block option.
  * Updated POT file.
...
= 0.9.3 =
  ...
  * Added top bottom padding option for comment button.
  * Added left right padding option for comment button.
  * Added border radius option for comment button.
  * Updated POT file.
...
= 0.9.6 =
  ...
  * Resolved global color errors.
  * Resolved metabox spacing error from single-post.php.
  * Resolved sticky header error from responsive.

= 0.9.7 =
  * added enable / disable option for date in single post.
  * added icon option for single post date.
  * added enable / disable option for author in single post.
  * added icon option for single post author.
  * added enable / disable option for comment in single post.
