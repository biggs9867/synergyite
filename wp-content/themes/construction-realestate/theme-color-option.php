...
// submenu hover color
	$construction_realestate_sub_menu_hover_color = get_theme_mod('construction_realestate_sub_menu_hover_color');

	$construction_realestate_custom_css .='.primary-navigation ul.sub-menu li a:hover{';
			$construction_realestate_custom_css .='color: '.esc_attr($construction_realestate_sub_menu_hover_color).' !important;';
	$construction_realestate_custom_css .='}';
