...
//sidebar size option
    ...
    $wp_customize->add_control('construction_realestate_single_post_featured_image',array(
       ...
       'section' => 'construction_realestate_single_post_settings',
		...
		$wp_customize->add_setting('construction_realestate_show_hide_single_post_categories',array(
			'default' => true,
			'sanitize_callback'	=> 'construction_realestate_sanitize_checkbox'
	  ));
	 $wp_customize->add_control('construction_realestate_show_hide_single_post_categories',array(
			'type' => 'checkbox',
			'label' => __('Single Post Categories','construction-realestate'),
			'section' => 'construction_realestate_single_post_settings'
	   ));
	...
	$wp_customize->add_setting('construction_realestate_sub_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'construction_realestate_sub_menu_hover_color', array(
		'label'    => __('Submenu Hover Color', 'construction-realestate'),
		'section'  => 'construction_realestate_contact',
		'settings' => 'construction_realestate_sub_menu_hover_color',
	)));
